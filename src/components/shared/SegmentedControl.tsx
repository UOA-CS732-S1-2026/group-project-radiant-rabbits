...
> = {
  lg: {
    ...
    active:
      "min-h-9 shrink-0 rounded-[length:var(--radius-lg)] bg-brand-surface px-3 py-1.5 text-center text-(length:--text-body-sm) font-bold text-brand-dark shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-brand-primary sm:min-h-10 sm:px-3.5 sm:py-2",
    inactive:
      "min-h-9 shrink-0 rounded-[length:var(--radius-lg)] px-3 py-1.5 text-center text-(length:--text-body-sm) font-bold text-brand-dark/80 transition hover:bg-brand-surface/60 hover:text-brand-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-brand-primary sm:min-h-10 sm:px-3.5 sm:py-2",
  },
  sm: {
    shell:
    ...
    inactive:
      "min-h-8 shrink-0 rounded-[length:var(--radius-md)] px-2.5 py-1.5 text-center text-(length:--text-body-sm) font-medium text-brand-dark/80 transition hover:bg-brand-surface/60 hover:text-brand-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-brand-primary sm:min-h-9 sm:px-3 sm:py-2",
  },
};
