...
export default function LandingHeader({
  ...
  return (
    <header className="w-full bg-gradient-to-r from-brand-primary to-brand-accent px-4 py-2.5 shadow-sm sm:px-6 sm:py-2.5">
      <div
