...
// Note: GitHub credentials are optional. If not provided, the app will use credentials provider
// or the app will still build successfully. Validation happens at runtime if GitHub login is attempted.
